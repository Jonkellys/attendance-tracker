...
>
  <head>
    ...
    <title>Delete User | <?php echo NOMBRE;?></title>
              ...
              <div class="card mx-auto mt-5 col-8">
                <div class="card" style="padding: 0px 2%;">
                  ...
                  <div class="container-fluid flex-grow-1 container-p-y">
                    ...
                    <form action='<?php echo SERVERURL; ?>conexiones/eliminarUser.php' enctype='multipart/form-data' method='POST' data-form='delete' class='FormularioAjax d-flex flex-row justify-content-center'>
